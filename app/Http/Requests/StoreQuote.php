...
class StoreQuote extends FormRequest
{
    ...
    {
        return [
            'title' => 'required|min:5|max:20|regex:/^[a-zA-Z0-9 ]+$/', // Longitud mínima y caracteres permitidos
            'description' => 'required|min:10', // Longitud mínima
            'site' => 'required|max:45|regex:/^[a-zA-Z0-9 ]+$/', // Longitud máxima y caracteres permitidos
            'dateTime' => 'required|date|date_format:Y-m-d\\TH:i', // Validar formato específico
        ];
    }
